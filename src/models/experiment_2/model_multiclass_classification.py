...
if __name__ == '__main__':
    ...
    indexes_train_non_zero_labels = np.where(train_data[3] != 0)[0]

    input_ids_train = train_data[1][indexes_train_non_zero_labels]
    attention_mask_train = train_data[2][indexes_train_non_zero_labels]
    labels_train = train_data[3][indexes_train_non_zero_labels] - 1

    indexes_val_non_zero_labels = np.where(val_data[3] != 0)[0]

    input_ids_val = val_data[1][indexes_val_non_zero_labels]
    attention_mask_val = val_data[2][indexes_val_non_zero_labels]
    labels_val = val_data[3][indexes_val_non_zero_labels] - 1
